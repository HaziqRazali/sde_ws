...
def generate_launch_description():
    ...
    ik_solver_node = Node(
        ...
        executable='robot_ik_solver',
        name='robot_ik_solver',
        parameters=[{
    ...
    # casadi_optimal_control_ik_pkg_share = get_package_share_directory('casadi_optimal_control_ik')
    # rviz_config_file = os.path.join(casadi_optimal_control_ik_pkg_share, 'rviz/ik_solver.rviz')
